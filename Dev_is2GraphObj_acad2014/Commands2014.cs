...
using EntityExtension_acad2014;
  ...
  {	  
		...
		public static void RotarSegmento()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				/*//-- DIBUJO LINEA VERDE ---//
				SegmentType L = is2GraphObj.RotateSegment(is2GraphTranslator.Tois2Graph(S1), 55, L00.Pi);
				...
				L = is2GraphObj.RotateSegment(is2GraphTranslator.Tois2Graph(S1), -75, L00.Pi);
				...
				//-- DIBUJO LINEA ROJA ---//
				L = is2GraphObj.RotateSegment(is2GraphTranslator.Tois2Graph(S1), 370, L00.Pi);
				...
				//-- DIBUJO LINEA VERDE ---//
				/*SegmentType L = is2GraphObj.RotateSegment(is2GraphTranslator.Tois2Graph(S1), 55, L00.Pf);
				Line L3 = is2GraphTranslator.ToAcad(L);
				L3.ColorIndex = 3;	// VERDE
				acBlkTblRec.AppendEntity(L3);
				acTrans.AddNewlyCreatedDBObject(L3, true);
				...
				//-- DIBUJO LINEA NARANJA ---//
				L = is2GraphObj.RotateSegment(is2GraphTranslator.Tois2Graph(S1), -75, L00.Pf);
				Line L4 = is2GraphTranslator.ToAcad(L);
				L4.ColorIndex = 30;	// NARANJA
				acBlkTblRec.AppendEntity(L4);
				acTrans.AddNewlyCreatedDBObject(L4, true);
				...
				//-- DIBUJO LINEA ROJA ---//
				L = is2GraphObj.RotateSegment(is2GraphTranslator.Tois2Graph(S1), -370, L00.Pf);
				Line L5 = is2GraphTranslator.ToAcad(L);
				L5.ColorIndex = 10;	// ROJA
				acBlkTblRec.AppendEntity(L5);
				acTrans.AddNewlyCreatedDBObject(L5, true);*/
		...
		public static void Bisel()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				const double d1 = 10;
				const double d2 = 10;
				is2GraphObj.SegmentSegmentChamfer(L00, L11, new ChamferDistante(d1), new ChamferDistante(d2), out P1, out P2);
		...
		public static void CircleCircleIntersect()
    {
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var entities = UserSelectEntity("CIRCLE", 2);
		...
		public static void ArcLineIntersect()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var selArc = UserSelectEntity("ARC", 1);
				Application.DocumentManager.MdiActiveDocument.Editor.WriteMessage("Seleccione ahora la Recta");
				var seltLine = UserSelectEntity("LINE", 1);
		...
		public static void ArcArcIntersect()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var entities = UserSelectEntity("ARC", 2);
		...
		public static void ArcCircleIntersect()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var seltCircle = UserSelectEntity("CIRCLE", 1);
		...
		public static void Segment_Segment_Fillet ()
		{
			...
			using (var acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var seltLine = UserSelectEntity("LINE", 2);
		...
		public static void Circle_Circle_Fillet ()
		{
			...
			using (var acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var seltLine = UserSelectEntity("CIRCLE", 2);
		...
		public static void Arc_Arc_Fillet()
		{
			...
			using (var acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var selArc = UserSelectEntity("Arc", 2);
		...
		#region - Command: Debug_Empalme -
		[CommandMethod("Debug_Empalme")]
		public static void Debug_Empalme()
		{
			Document acDoc = Application.DocumentManager.MdiActiveDocument;
			Database acCurDb = acDoc.Database;
		...
		[CommandMethod("Debug_Arc")]
		public static void DebugArc()
		{
			Document acDoc = Application.DocumentManager.MdiActiveDocument;
			Database acCurDb = acDoc.Database;
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var entities = UserSelectEntity("ARC", 1);
		...
		public static void DebugArcLineIntersect()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				LineType isL = new LineType(C.Pi, C.Angle);
		...
		public static void Point_In_Line()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var entities = UserSelectEntity("LINE", 1);
		...
		public static void Point_In_Circle()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var entities = UserSelectEntity("CIRCLE", 1);
		...
		private static List<Entity> UserSelectEntity (string nameEntity, Int16 count)
	  {
			Document acDoc = Application.DocumentManager.MdiActiveDocument;
			Database acCurDb = acDoc.Database;
	  ...
	  private static void Circle_From_2Tangent_1Raduis()
	  {
			Document acDoc = Application.DocumentManager.MdiActiveDocument;
			Database acCurDb = acDoc.Database;
		...
		private static void Circle_From_3Tangent ()
		{
			...
			using (Transaction acTrans = acCurDb.TransactionManager.StartTransaction())
			{
				...
				var seltLine = UserSelectEntity("LINE", 3);
