...
namespace EntityExtension_acad2016
{
	...
	public class CircleEx : Circle
	{
		...
		/// <param name="r"></param>
		/// <param name="normal"></param>
		/// <param name="s1_right"></param>
		/// <param name="s2_right"></param>
		...
		public CircleEx (Line L1, Line L2, Line L3, Vector3d normal, bool right_up = true)
		{
			...
			intersec = 0;
			x1 = is2GraphObj.SegmentsApparentIntersect(S1, S2, out A);
			x2 = is2GraphObj.SegmentsApparentIntersect(S2, S3, out B);
			x3 = is2GraphObj.SegmentsApparentIntersect(S3, S1, out C);
			...
			Utilities_acad2016.AcadUtilities.AddPinToModel(is2GraphTranslator.ToAcad_DB(A), 34, 0.3, 2);
			Utilities_acad2016.AcadUtilities.AddPinToModel(is2GraphTranslator.ToAcad_DB(B), 34, 0.3, 2);
			Utilities_acad2016.AcadUtilities.AddPinToModel(is2GraphTranslator.ToAcad_DB(C), 34, 0.3, 2);
